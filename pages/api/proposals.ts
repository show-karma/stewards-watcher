...
import { moonbaseProposals, moonbeamProposals, moonriverProposals } from 'utils/api/proposals';
...
const handler: NextApiHandler = async (
  ...
  if (req.query.dao !== 'moonriver' && req.query.dao !== 'moonbeam' && req.query.dao !== 'moonbase' ) {
    res.statusCode = 400;
